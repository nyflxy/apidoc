#
# @author: Daemon Wang 我在东汇恒德的同事 ^_^
# Created on 2016-03-02
# Alter by Niyoufa on 2017-01-06
...
smtp = {
    "host": "email.163.com",
    "user": "niyoufa2017@163.com",
    "password": "19922017nyf",
    "duration": 10,
    "tls": False
}
...
if __name__ == "__main__":
    ...
    send_email('niyoufa2017@163.com', ["1061794187@qq.com"], "测试excel文件邮件发送", '',
           html=u'<p>%s</p><p>日期：%s - %s</p>' % (u"测试excel文件邮件发送", u"2015", u"2016"),
           attachments=[])#{"filename": u"微博预测.txt", "data": u"/home/nyf/微博预测.txt"}
